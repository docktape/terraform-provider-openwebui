...
- `endpoint` (String) Base URL for the Open WebUI API, e.g. `https://openwebui.example.com/api/v1`. Defaults to `http://localhost:3000/api/v1`. Can also be set via the `OPENWEBUI_ENDPOINT` environment variable.
